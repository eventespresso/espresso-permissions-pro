...
<div class="wrap">
	...
	<div id="poststuff">
		<form id="roles" action="<?php echo $current_page; ?>" method="post">
			...
			<ul class="subsubsub">
				<li><a <?php if ( 'active' !== $_GET['role_status'] && 'inactive' !== $_GET['role_status'] ) echo 'class="current"'; ?> href="<?php echo admin_url( esc_url( "admin.php?page=roles" ) ); ?>"><?php _e('All', 'event-espresso'); ?> <span class="count">(<span id="all_count"><?php echo $all_roles; ?></span>)</span></a> | </li>
				<li><a <?php if ( 'active' == $_GET['role_status'] ) echo 'class="current"'; ?> href="<?php echo admin_url( esc_url( "admin.php?page=roles&amp;role_status=active" ) ); ?>"><?php _e('Active', 'event-espresso'); ?> <span class="count">(<span id="active_count"><?php echo $active_roles; ?></span>)</span></a> | </li>
				<li><a <?php if ( 'inactive' == $_GET['role_status'] ) echo 'class="current"'; ?> href="<?php echo admin_url( esc_url( "admin.php?page=roles&amp;role_status=inactive" ) ); ?>"><?php _e('Inactive', 'event-espresso'); ?> <span class="count">(<span id="inactive_count"><?php echo $inactive_roles; ?></span>)</span></a></li>
			</ul>
			<div class="tablenav">
